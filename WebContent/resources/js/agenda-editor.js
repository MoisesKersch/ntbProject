		          ...
		          .extend(
		              altEditor.prototype,
		              {
		                ...
		                _setup : function() {
		                  ...
		                  // add Edit Button
		                  if (this.s.dt.button('agendaEdit:name')) {
		                    this.s.dt.button('agendaEdit:name').action(
		                  ...
		                  // add Delete Button
		                  if (this.s.dt.button('agendaDelete:name')) {
		                    this.s.dt.button('agendaDelete:name').action(
		                        function(e, dt, node, config) {
		                          var rows = dt.rows({
		                            selected : true
		                          }).count();
		                  ...
		                  // add Add Button
		                  if (this.s.dt.button('agendaAdd:name')) {
		                    this.s.dt.button('agendaAdd:name').action(
		                        function(e, dt, node, config) {
		                          var rows = dt.rows({
		                            selected : true
		                          }).count();
		                ...
		                _openEditModal : function() {
		                  ...
		                  $('#novoAgendaModal').modal('show'); 
		                  
		                  $('#agendaSaveOrEdit').val("editagenda");
		                  
		                  $('#assunto').val(adata.data()[0][columnDefs[0].name])
		                  $('#anotacao').val(adata.data()[0][columnDefs[1].name])
		                  $('#quando').val(adata.data()[0][columnDefs[2].name])
		                  $('#onde').val(adata.data()[0][columnDefs[3].name])
		                  $('#idAgenda1').val(adata.data()[0][columnDefs[6].name])
		                  $('#idContato').val($('#idContato').val());
		                ...
		                _openDeleteModal : function() {
		                     ...
		                     $('#removeAgenda').val(adata.data()[0][columnDefs[6].name])
		                },
		                ...
		                _openAddModal : function() {
		                	...
		                	var contactId = $("#idContato").val();
		                	
		                	$('#agendaForm')[0].reset();
		                	
		                	$("#idContato").val(contactId);
		                	$('#quando').val(currentDate);
