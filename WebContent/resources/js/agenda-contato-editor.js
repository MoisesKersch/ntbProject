      ...
      $
          ...
          <input type="submit" form="altEditor-form" class="btn btn-primary">Salvar</input>\
                ...
                _openEditModal : function() {
                  ...
                  $('#novoCadastroModal').modal('show'); 
                  $('#saveOrEdit').val("edit");
                  
                  $('#nome').val(adata.data()[0][columnDefs[0].name])
                  $('#telefone').val(adata.data()[0][columnDefs[1].name])
                  $('#celular').val(adata.data()[0][columnDefs[2].name])
                  $('#email').val(adata.data()[0][columnDefs[3].name])
                  $('#cidade').val(adata.data()[0][columnDefs[5].name])
                  $('#estado').val(adata.data()[0][columnDefs[6].name])
                  $('#ultimoContato').val(adata.data()[0][columnDefs[7].name])
                  $('#proximoContato').val(adata.data()[0][columnDefs[8].name])
                  $('#descricao').val(adata.data()[0][columnDefs[10].name])
                  $('#id').val(adata.data()[0][columnDefs[11].name])
                ...
                _openDeleteModal : function() {
                     ...
                     $('#deleteReuniao').modal('show'); 
                     
                     
                     $('#remove').val(adata.data()[0][columnDefs[11].name])
                },
                ...
                _openAddModal : function() {
                	...
                	$('#ultimoContato').val(currentDate);
                	$('#proximoContato').val(currentDate);
                	$('#saveOrEdit').val("save");
                    $('#novoCadastroModal').modal('show');
                },
