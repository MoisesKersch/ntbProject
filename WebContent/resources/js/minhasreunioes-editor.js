      ...
      $
          ...
          <input type="submit" form="altEditor-form" class="btn btn-primary">Salvar</input>\
                ...
                _openEditModal : function() {
                  ...
                  $('#novoReuniaoModal').modal('show'); 
                  $('#saveOrEdit').val("editarreuniao");
                  
                  var dataHora = adata.data()[0][columnDefs[2].name].split(" ");
         
                  $('#data').val(dataHora[0])
                  $('#hora').val(dataHora[1])
                  $('#participantes').val(adata.data()[0][columnDefs[3].name])
                  $('#observacoes').val(adata.data()[0][columnDefs[4].name])
                  $('#reuniaoId').val(adata.data()[0][columnDefs[5].name])
                }, 
                ...
                _openDeleteModal : function() {
                     ...
                     $('#remove').val(adata.data()[0][columnDefs[5].name])
                },
                ...
                _openAddModal : function() {
                	...
                	$('#reuniaoForm')[0].reset();
                	$('#saveOrEdit').val("registrarnovareuniao");       	
                    $('#novoReuniaoModal').modal('show');
                },
