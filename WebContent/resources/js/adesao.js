...
//	});
	...
	if (!(a == null || a == undefined || a == '')) {
		validarPatrocinador();
		$("#patrocinador").prop('readonly', true);
		$("#btnIndicador").parent().remove();
	}

//	$('#senha1, #senha2').keyup(function() {
//		validarSenhas();
//	});
...
function validarPatrocinador() {
	$.post("validapatrocinador", 
		...
		function(resposta) {
			...
			{
				$("#patrocinadorNomeDisplay").html("");
				$("#patrocinadorNome").removeClass("hidden");
			} 
			else {
				$("#patrocinadorNome").addClass("hidden");
				$("#patrocinadorNomeDisplay").html(resposta);
			}
   		}
   	);		
}
...
//	$('#senhaInfo').html('');
//	senhasConferem = true;
//	if (!(senha1 == null || senha1 == '' || senha1 == undefined))
//	{
//		if (!(senha1 === senha2))
//		{
//			$('#senhaInfo').html('Senhas não Conferem');
...
//		if (!(email1 === email2))
//		{
//			$('#emailInfo').html('Emails não conferem!');
//			emailsConferem = false;
//		}
//	}
//	enableButton();
//}
...
//	$('#buttonCompleta').prop('disabled', (!(senhasConferem && emailsConferem)));
//}
