				...
				<section class="content">
					...
					<div class="box box-primary">
						...
						<div class="box-body">
							...
							<h3>Pedido concluido com sucesso</h3>

							<div>
								<a href="downloadboleto/${id}" class="btn btn-primary">
									<span class="glyphicon glyphicon-download" aria-hidden="true"></span>
									Download boleto
								</a>
								<a href="compras" class="btn btn-info">
									<i class="fa fa-cart"></i>  <span><b>Comprar mais...</b></span>
								</a>
							</div>		
