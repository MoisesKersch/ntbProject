package br.com.adaptaconsultoria.amr.test.util;
...
public class GeraCPF {
	...
	public String geraCPFFinal() {
		...
		/*
		 * Aqui vamos concatenar todos os valores da lista em uma string Por que isso? Porque a formatacao que o ArrayList gera me impossibilitaria de usar a mascara, pois junto
		 * com os numeros gerados ele tambem gera caracteres especias. Ex.: lista com inteiros (de 1 a 5) [1 , 2 , 3 , 4 , 5] Dessa forma o sistema geraria a excecao ParseException
		 */
		for (int item : listaAleatoria) {
			texto += item;
		}
