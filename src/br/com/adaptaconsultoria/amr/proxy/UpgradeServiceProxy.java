 ...
 *
 */
public class UpgradeServiceProxy {

	private static String URI = AMRProperties.getInstance().getPropriedade("upgrade.service.uri");
	...
	public RetEnvUpgrade doPost(String envArquivo) throws Exception {
		...
		RetEnvUpgrade ret = new RetEnvUpgrade();
		try {
			ret.parse(texto);
		} catch (Exception e) {
			e.printStackTrace();
