package br.com.adaptaconsultoria.amr.util.documento;
 ...
 *
 */
public class DocumentoPessoalUtil {
	...
	public static boolean validaCPF(String cpf) throws Exception {
		cpf = TextoUtil.removeNaoNumericos(cpf);
	...
	public static boolean validaCNPJ(String cnpj) throws Exception {
		cnpj = TextoUtil.removeNaoNumericos(cnpj);
	...
	public static int getTipoDocumento(String numero) throws Exception {
		numero = TextoUtil.removeNaoNumericos(numero);
		if (numero.length() == 11)
			return CPF;
	...
	public static void main(String[] args) throws Exception {
		System.out.println(DocumentoPessoalUtil.validaCPF("00671980904"));
		System.out.println(DocumentoPessoalUtil.formataCPF("00671980904"));
		System.out.println(DocumentoPessoalUtil.validaCNPJ("41.585.767/0001-07"));
		System.out.println(DocumentoPessoalUtil.validaCNPJ("41.585.767/0001-05"));
		System.out.println(DocumentoPessoalUtil.getTipoDocumento("41.585.767/0001-07"));
	}
